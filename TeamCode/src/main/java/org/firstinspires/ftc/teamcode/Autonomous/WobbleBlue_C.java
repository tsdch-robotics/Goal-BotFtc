...
public class WobbleBlue_C extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        DriveRobot(571, -1,1,1,-1,0,0,0);//strafe left 11 in
        sleep(250);
        ...
        sleep(250);
        DriveRobot(1753, 1,-1,-1,1,0,0,0);//strafe right 33.75 in
        sleep(250);
        DriveRobot(6117, -.5,-.5,-.5,-.5,0,0,0);//move backward 117.75 in
        sleep(250);
        DriveRobot(650,0,0,0,0,1,0,0);//move the arm up to vertical
        sleep(250);
        DriveRobot(1753, -1,1,1,-1,0,0,0);//strafe left 33.75 in
        sleep(250);
        DriveRobot(6117, .5,.5,.5,.5,0,0,0);//move forward 117.75 in
        sleep(250);
        DriveRobot(650,0,0,0,0,-1,0,0);//move the arm down to horizontal
        ...
        DriveRobot(650,0,0,0,0,1,0,0);//move the arm up to vertical
        sleep(250);
        DriveRobot(1558, -.5,-.5,-.5,-.5, 0,0,0);//move backward 30 in
    }
