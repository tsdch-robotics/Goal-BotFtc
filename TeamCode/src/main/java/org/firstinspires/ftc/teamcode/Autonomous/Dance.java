...
@Autonomous(name="Dance", group="ChampBot")
public class Dance extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        DriveRobot(300, 1, 1, -1, -1, 1, 0, 0, 0);
        DriveRobot(300, 1, 1, -1, -1, 1, 1, 0, 1);
        DriveRobot(300, 1, 1, -1, -1, -1, 1, 1, 0);
        DriveRobot(300, 1, 1, 1, 1, -1, 0, 0, 1);
        DriveRobot(300, -1, -1, 1, 1, 1, 1, 1, 0);
        DriveRobot(300, 1, 1, -1, -1, 1, 0, 0, 0);
        DriveRobot(300, 1, 1, -1, -1, 1, 1, 0, 1);
        DriveRobot(300, 1, 1, -1, -1, -1, 1, 1, 0);
